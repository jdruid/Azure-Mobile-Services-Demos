/**
*   This is a generic script that will process each of the authentications sor social networks to return a user object.
*   
*           @param request - the request object is the "result.userid" that was returned from client.login()
*/   
